...
<?php
    ...
    <li><a href="contact.php"><i class="fa fa-phone"></i> Contact</a>
                ...
                <div class="right_col" role="main">
                    ...
                    $q_post = "select post_title, post_subtitle, post_body from post where post_id = $post_id";

                    $result_post = $mysql->query($q_post);
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form  data-parsley-validate class="form-horizontal form-label-left "  method="POST" action="save_post.php" id="post_form" enctype="multipart/form-data" >
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8 col-sm-8  col-xs-12 col-md-offset-1 col-sm-offset-1">
                                                ...
                                                <input type="text" id="first-name"  name="post_title" required="required" placeholder="Enter Title" value="<?php echo $post_title ?>" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6  col-xs-12 col-md-offset-1 col-sm-offset-1">
                                                <input type="text" id="first-name"  name="post_subtitle" required="required" placeholder="Enter Subtitle" value="<?php echo $post_subtitle ?>" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8 col-sm-8  col-xs-12 col-md-offset-1 col-sm-offset-1">
                                                ...
                                                <div id="editor-one" name="editor-data" class="editor-wrapper"><?php echo $post_body ?></div>
