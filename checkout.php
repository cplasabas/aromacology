<html>
    ...
    <head>
        ...
        <script>
            (function () {
                $('#featured-carousel').carousel({interval: 3600});
            }());
        ...
        <div class="container-fluid" style="margin: 0 15% 0 15%;">
            ...
            <div class="row main-row"  style="height: 500px; margin: 50px 10px 0 10px;">
                <div class="container-fluid">
                    ...
                    <div class="col-lg-6 ">
                        <div class="row ">
                            <div class="panel panel-default">
                                <div class="panel-heading"style="color: #e55227 !important;font-size: 20px;" >Payment Option</div>
                                <div class="panel-body" style=" margin: 0 5% 0 5%;">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img class="img-responsive " style="height:auto; " src="images/cod.png" >
                                        </div>
                        ...
                        <div class="row ">
                            <div class="panel panel-default">
                                <div class="panel-heading " style="color: #e55227 !important;font-size: 20px;">Shipping Details</div>
                                <div class="panel-body" style=" margin: 0 5% 0 5%;">
                                    <div class="row" style="text-transform: capitalize;">
                                        <?php
                                        $q_address = "select address from user_detail where user_detail_id = $user_id";

                                        $result_address = $mysql->query($q_address);
                                        ...
                                        echo $fromatted_address;
                                        ?>
                                    
                                    </div>
                                    <div class="row" style="margin-top: 10%;">
                                        <form class = "product-page-form "  action = "customer-checkout.php" method = "post">
                                            <button type = "submit" name = "submit" class = "btn btn-default btn-large add-to-cart-button pull-right">PLACE YOUR ORDER</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal fade" id="checkout-modal" role="dialog" style="padding-top: 15%;">
                    ...
                    <div class="col-lg-5 col-lg-offset-1">
                        <div class="row">
                            <div class="panel panel-default">
                                <div class="panel-heading" style="color: #e55227 !important;font-size: 20px;">Order Summary</div>
                                <div class="panel-body" style=" margin: 0 5% 0 5%;">
                                    <div class="row">
                                        <table class="table" >
                                            <thead>
...
// 1234.57
                                                        ?>
                                                        <tr>
                                                            <td><p style="text-transform: capitalize"><?Php echo $product_name ?></p></td>
                                        ...
                                        <table class="table" >
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><p class="pull-right">&#8369;<?Php echo $total_format ?></p></td>
